...
class MultiHeadedSelfAttention(nn.Module):
    ...
    def __init__(self, embedding_dim: int, attention_dim: int, num_heads: int):
        ...
        self.head_size     = attention_dim // num_heads # Size of the attention dim for each head
        self.heads         = [self.SingleHeadAttention(embedding_dim, self.head_size) for _ in range(num_heads)] # All of the heads 
